...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring(title='Adjective', prompt="Give adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='Liquid', prompt="Give liquid")
    # Get the player to enter a body part
    body = simpledialog.askstring(title='Body', prompt="Give body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Verb', prompt="Give verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title='place', prompt="Give place")
